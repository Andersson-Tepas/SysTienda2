...
namespace SysTienda2.Controllers
{
    public class ServicioController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdServicio,Descripción")] Servicio servicio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdServicio,Descripción")] Servicio servicio)
        {
