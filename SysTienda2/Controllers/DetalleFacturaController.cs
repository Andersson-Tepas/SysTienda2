...
namespace SysTienda2.Controllers
{
    public class DetalleFacturaController : Controller
    {
        ...
        {
            var bDContext = _context.DetalleFactura.Include(d => d.IdFacturaNavigation).Include(d => d.IdServicioNavigation);
        ...
        public async Task<IActionResult> Create([Bind("IdDetalleFactura,IdFactura,IdServicio,Cantidad,Precio")] DetalleFactura detalleFactura)
        {
            ...
            ViewData["IdServicio"] = new SelectList(_context.Servicio, "IdServicio", "IdServicio", detalleFactura.IdServicio);
            return View(detalleFactura);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdDetalleFactura,IdFactura,IdServicio,Cantidad,Precio")] DetalleFactura detalleFactura)
        {
